...
describe('CollectionEditDialogComponent', () => {
  ...
  it('should require the collection name field', () => {
    ...
    expect(
      component.wordGroupForm[WordGroupParameterEnum.NAME]().getError('required')?.message,
  ...
  function setFormValue(value: WordGroupRequest): void {
    component.wordGroupForm[WordGroupParameterEnum.NAME]().value.set(
      value[WordGroupParameterEnum.NAME],
    );
