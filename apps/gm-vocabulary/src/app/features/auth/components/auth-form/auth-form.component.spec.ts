...
import { FormFieldValidationMessageKeyEnum } from '../../../../shared/enums/form-field-validation-message-key.enum';
...
describe('AuthFormComponent', () => {
  ...
  it('should show passwords mismatch error in signup mode', async () => {
    ...
    expect(
      component.authForm
        .repeatPassword()
        .getError(FormFieldValidationMessageKeyEnum.PASSWORDS_MISMATCH),
    ).toBeTruthy();
    expect(getErrorsText()).toContain(
