...
export class WordsController {
  ...
  @Post()
  create(@Body() createWordDto: CreateWordDto, @CurrentUser() user: AuthenticatedUser) {
  ...
  @Post('copy')
  copy(@Body() copyWordsDto: CopyWordsDto, @CurrentUser() user: AuthenticatedUser) {
  ...
  @Delete()
  remove(@Body() deleteWordsDto: DeleteWordsDto, @CurrentUser() user: AuthenticatedUser) {
